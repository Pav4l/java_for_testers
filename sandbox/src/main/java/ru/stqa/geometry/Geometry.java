...
//        };
        squares.peek(Square::printSquareArea).forEach(Square::printPerimeterArea);
...
//        Triangle.printTrianglePerimeter(new Triangle(5.0, 12.0, 13.0));
//        Triangle.printTriangleArea(new Triangle(5.0, 12.0, 13.0));
    }
